      ...
      <div class="list">
        ...
        <el-dialog title="查看准考证信息" :visible.sync="seeDialog" v-if="seeDialog" width="450px">
          <div class="info" id="newImg">
            ...
            <img src="https://api.ostep.com.cn/file/spec/signet.png" alt="" style="width: 100px;height: 100px;position: absolute;bottom: 140px;right: 55px;z-index: 1;" crossorigin="anonymous">
            <h3>巴中龙泉外国语学校</h3>
            <h3>2020年直升考试</h3>
            ...
            <el-row>
              ...
              <el-col :span="10">
                <div><img style="width: 125px;height: 175px;" :src="infoData.photo || 'https://api.ostep.com.cn/file/photos/sample.jpeg'" alt=""></div>
              </el-col>
            </el-row>
        ...
        <el-dialog title="导入学生成绩" :visible.sync="importDialog" v-if="importDialog" width="450px">
          <el-form>
            <el-upload
              class="upload-demo"
              ref="upload"
              action="https://api.ostep.com.cn/bzlq/candidate/senior/import"
  ...
  export default {
    ...
    methods: {
      ...
      getList () {
        ...
        this.axios.post(`https://api.ostep.com.cn/bzlq/candidate/senior/search`, query).then(res => {
          if(res.data.result_code === 200){
      ...
      see(id){
        this.axios.get(`https://api.ostep.com.cn/bzlq/candidate/senior/get?id=${id}`).then(res => {
          if(res.data.result_code === 200){
      ...
      exportList(){
        window.open('https://api.ostep.com.cn/bzlq/candidate/senior/export')
      },
      importList(){
